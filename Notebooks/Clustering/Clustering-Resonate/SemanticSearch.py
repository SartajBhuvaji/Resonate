'''the code is from https://deepnote.com/blog/semantic-search-using-faiss-and-mpnet'''
...
class FaissForQuerySearch:
    ...
    def search_query(self, query, k=1):
        ...
        return [self.labels[idx] for idx, score in zip(I[0], D[0]) if idx in self.doc_map]
